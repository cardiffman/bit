...
#include "shader_utils.h"//#include "../common/shader_utils.h"
...
int init_resources()
{
    ...
    GLuint vs, fs;   
    if ((vs = create_shader("sprites.v.glsl", GL_VERTEX_SHADER))   == 0) 
        return 0;   
    if ((fs = create_shader("sprites.f.glsl", GL_FRAGMENT_SHADER)) == 0) 
        return 0;   
