...
Container containers[] = {
		{ 0 },
		{ 1, 1, 12, { 0*145, 0, 145, 210 }, 0, 0 },
		{ 2, 2, 13, { 1*145, 0, 145, 210 }, 0, 0 },
		{ 3, 3, 13, { 2*145, 0, 145, 210 }, 0, 0 },
		{ 4, 4, 13, { 3*145, 0, 145, 210 }, 0, 0 },
		{ 5, 5, 13, { 4*145, 0, 145, 210 }, 0, 0 },
		{ 6, 6, 13, { 5*145, 0, 145, 210 }, 0, 0 },
		{ 7, 7, 13, { 6*145, 0, 145, 210 }, 0, 0 },
		{ 8, 8, 13, { 7*145, 0, 145, 210 }, 0, 0 },
		{ 9, 9, 13, { 8*145, 0, 145, 210 }, 0, 0 },
		{ 10, 10, 13, { 9*145, 0, 145, 210 }, 0, 0 },
		{ 11, 11, 13, { 10*145, 0, 145, 210 }, 0, 0 },
		{ 12, 0, 13, { 0*145, 0, 145, 210 }, 0, 0 },
		{ 13, 0, 0, { 0, 340, 11*145, 210 }, 0, 0 },
};
...
Rectangle screenArea(Container& container)
{
	auto area = container.area;
	auto pid = container.parentId;
	while (pid != 0)
	{
		Container& parent = containers[pid];
		area.x += parent.area.x;
		area.y += parent.area.y;
		pid = parent.parentId;
	}
	return area;
}
GtkWidget* renderContainer(Container& container)
{
	...
	for (unsigned i=1; i<numContainers; ++i)
	{
		...
		gtk_widget_set_size_request(child, containers[i].area.width, containers[i].area.height);
	}
